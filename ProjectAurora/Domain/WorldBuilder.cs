...
namespace ProjectAurora.Domain
{
    public class WorldBuilder : IWorldBuilder
    {
        ...
        public ProjectAurora.Data.Room BuildWorld()
        {
            ...
            var turbines = new Room("Turbines", "Turbines", "You are standing between the wind turbines. Some are turned off while others spin slowly. To the east is a control tower connected to the turbines; to the west you can hear a stream of water; to the south is a metal box that may contain something useful.") { Occupant = new ProjectAurora.Domain.NPCs.TurbinesOperator() };
